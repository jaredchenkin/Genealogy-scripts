...
_vital_records = RM.SourceTemplate(
  ...
  [
    ...
    RM.SourceTemplateField('CertificateNo', RM.FieldType.TEXT, 'Certificate Number', True)
  ],
...
def setup():
  ...
  with RM.create_db_connection(config['FILE_PATHS']['DB_PATH'], config['FILE_PATHS']['RMNOCASE_PATH']) as conn:
